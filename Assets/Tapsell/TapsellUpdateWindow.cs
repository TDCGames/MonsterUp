...
namespace TapsellSDK.Editor
{
	public class TapsellUpdateWindow : EditorWindow
	{
		...
		void OnGUI ()
		{
			...
			GUILayout.Label("LaTapsellTestV3 version: " + TapsellSettings.getLaTapsellTestV3PluginVersion());
			...
			GUILayout.Label("You can download the laTapsellTestV3 version from the Tapsell answers page.", EditorStyles.wordWrappedMiniLabel, GUILayout.MaxWidth(380));
